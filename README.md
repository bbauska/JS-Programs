...
<!-- JavaScript Loops -->
  ...
  <li href="#ex60">JS Best Practices</li>
  <li href="#ex61">JS Mistakes</li>
  <li href="#ex62">JS Performance</li>
  <li href="#ex63">JS Reserved Words</li>
<!-- JavaScript Objects -->  
  <li href="#ex64">JS Objects</li>
  <li href="#ex65">Object Properties</li>
  <li href="#ex66">Object Methods</li>
  <li href="#ex67">Object Display</li>
  <li href="#ex68">Object Accessors</li>
  <li href="#ex69">Object Constructors</li>
  <li href="#ex70">Object Prototypes</li>
  <li href="#ex71">Object Iterables</li>
  <li href="#ex72">Object Sets</li>
  <li href="#ex73">Object Maps</li>
  <li href="#ex74">Object Reference</li>
<!-- JavaScript Functions -->
  <li href="#ex75">JS Functions</li>
  <li href="#ex76">Function Parameters</li>
  <li href="#ex77">Function Invocation</li>
  <li href="#ex78">Function Call</li>
  <li href="#ex79">Function Apply</li>
  <li href="#ex80">Function Bind</li>
  <li href="#ex81">Function Closures</li>
<!-- JavaScript Classes -->
  <li href="#ex82">JS Classes</li>
  <li href="#ex83">Class Inheritance</li>
  <li href="#ex84">JS Async</li>
  <li href="#ex85">JS PromisesClass</li>
  <li href="#ex86">JS Async / Await</li>
  <li href="#ex87">JS HTML DOM</li>
  <li href="#ex88">JS Browser BOM</li>
  <li href="#ex89">JS Web APIs</li>
  <li href="#ex90">JS AJAX</li>
  <li href="#ex91">JS JSON</li>
  <li href="#ex92">JavaScript vs jQuery: A Comprehensive Comparison</li>
</ul>
